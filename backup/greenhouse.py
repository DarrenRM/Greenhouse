...
class WindowManager:
    ...
    def save_window_position(self, hwnd):
        ...
        self.saved_window_positions[hwnd] = {
...
class WindowManagerGUI:
    ...
    def _debounced_highlight(self, hwnd, selected):
        ...
        # Save window position immediately
        if selected:
            ...
            for i, (hwnd, _, _) in enumerate(windows):
                try:
                    ...
                    if icon:
                        ...
                        # Use after() instead of after_idle() for more reliable execution
